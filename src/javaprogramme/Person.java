...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        p1.setFirstName(""); // firstName is set to an empty string
        p1.setLastName(""); // lastName is set to an empty string
        p1.setAge(10);
        System.out.println("fullName= " + p1.getFullName());
        System.out.println("teen= " + p1.isTeen());
        p1.setFirstName("John"); // firstName is set to "John"
        p1.setAge(18);
        System.out.println("fullName= " + p1.getFullName());
        System.out.println("teen= " + p1.isTeen());
        p1.setLastName("Smith"); // lastName is set to "Smith"
        System.out.println("fullName= " + p1.getFullName());
    }
}
